...
int main(){
	...
	printf("\n");
	printf("Hola, los integrantes de este equipo son:\n");
	printf("Erick Ian Vilchis Trejo.\n");
	printf("Gerardo Velazquez Zepeda.\n");
	printf("Hernández Cuétaro Melanie.\n");
	printf("Villegas Herrera Jesus Esau.\n");
	system("pause");
	system("cls");
	repetir:
	ro=menu();
